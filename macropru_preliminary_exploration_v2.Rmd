...
We also included various measures of economic inequality from [GET]
...
\begin{figure}
    ...
    The figures were created using estimates from the third models show in Tables \ref{tighten_table} and \ref{loosen_table}. In the left-panel GDP growth was fitted at the democratic sample's 90th percentile--7.4. In the right-panel GDP growth was fitted at the 10th percentile---0.85. Inflation and the cumulative number of previous tightening moves were fitted at the sample mean.  
    }}
\end{figure}
